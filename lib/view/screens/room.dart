              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    ...
                    if(rooms_provider.rooms[index].cagesCount>0){
                      const snackBar = SnackBar(
                        content: Text('You Can not delete this room, it contains cages'),
                      );
                      ...
                      ScaffoldMessenger.of(context)
                        ...
                        rooms_provider.delete_room(rooms_provider.rooms[index]
                            .id);
                      }));
                    }
                  ...
                  child:Icon(Icons.delete_forever,color:rooms_provider.rooms[index].cagesCount>0?Colors.grey[350] :Color(0xfff79281),),
...
//         context, MaterialPageRoute(builder: (context)=>Dashboard(selected_index: selected_index,))).then((value) {
//           setState(() {
